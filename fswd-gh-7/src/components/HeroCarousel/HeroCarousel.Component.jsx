...
const HeroCarousel = () => {
    const [images] = useState([    //Importing Image URLs
    {
  "adult": false,
...
const settingsLG = {        //Using React-Slice
    arrows: true,
    dots: true,
    infinite: true,
    slidesToShow: 1,
...
const settings = {
  ...
  return (
    <>            {/* Fragments */}
        ...
        <div className='hidden lg:block'>             {/* On Larger Screen Size - Code will be Vissible, Hidden on Smaller & Medium Screen Size */}
        <HeroSlider {...settingsLG}>            {/* Settings Large */}
                {
                    images.map((images, index)=>(
