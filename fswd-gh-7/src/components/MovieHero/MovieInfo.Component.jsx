  ...
  return <>
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="flex items-center gap-3 w-full">
          <button onClick={rentMovie} className="bg-red-500  py-4 px-7 text-white font-semibold rounded-lg">Rent ₹149</button>
          <button onClick={buyMovie} className="bg-red-600  py-4 px-7 text-white font-semibold rounded-lg">Buy ₹599</button>
        </div>
      </div>
    </>
}
